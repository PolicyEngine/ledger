...
Ledger only records source-backed inputs. Populace owns the active calibration
...
from ledger.source_package import SOURCE_PACKAGE_ALIASES, SOURCE_PACKAGE_FILENAME
...
class TargetSourceCoverage:
    ...
    @property
    def has_ledger_package(self) -> bool:
        """Return whether this family has at least one Ledger package alias."""
...
US_POVERTY_NONFILER_TARGET_COVERAGE: tuple[TargetSourceCoverage, ...] = (
    ...
    TargetSourceCoverage(
        ...
        notes=(
            "Needed for SPM capped housing subsidy resources. Current Ledger has "
