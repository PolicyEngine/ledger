"""Concept-alignment validation for Ledger facts."""
...
from ledger.core import AggregateFact, build_fact_key


@dataclass(frozen=True)
class ConceptAlignment:
    """One source-to-canonical concept alignment asserted by Ledger."""
...
def validate_concept_alignments(
    ...
    *,
    ...
    """Validate Ledger concept alignments against optional Axiom CLI metadata."""
