...
SOURCE_PACKAGE_ALIASES = {
    "bea-nipa-pension-contributions": Path("packages/bea/nipa_pension_contributions"),
    "bea-nipa-personal-income-disposition": Path(
        "packages/bea/nipa_personal_income_disposition"
    ),
    "bea-nipa-personal-income-components": Path(
        "packages/bea/nipa_personal_income_components"
    ),
    "bea-nipa-total-wages-salaries": Path("packages/bea/nipa_total_wages_salaries"),
    "bea-regional-state-personal-income-components-2024": Path(
        "packages/bea/regional_personal_income_state"
    ),
    "cbo-revenue-projections-income-by-source-2026-02": Path(
        "packages/cbo/revenue_projections_income_by_source_2026_02"
    ),
    "census-pep-2024-national-age-sex": Path(
        "packages/census/pep_2024_national_age_sex"
    ),
    "census-pep-2023-state-age-sex": Path("packages/census/pep_2023_state_age_sex"),
    "census-pep-2023-puerto-rico-age-sex": Path(
        "packages/census/pep_2023_puerto_rico_age_sex"
    ),
    "census-population-projections-2023": Path(
        "packages/census/population_projections_2023"
    ),
    "census-acs-s0101-national-age-2024": Path(
        "packages/census/acs_s0101_national_2024"
    ),
    "census-acs-s0101-state-age-2024": Path("packages/census/acs_s0101_state_2024"),
    "census-acs-s0101-congressional-district-age-2024": Path(
        "packages/census/acs_s0101_district_2024"
    ),
    "census-acs-s2201-congressional-district-snap-2024": Path(
        "packages/census/acs_s2201_district_2024"
    ),
    "census-cd119-sld-2024": Path("packages/census/cd119_sld_2024"),
    "census-b01001-female-age-2023": Path("packages/census/b01001_female_15_44_2023"),
    "census-stc-individual-income-tax": Path(
        "packages/census/stc_individual_income_tax"
    ),
    "cdc-vsrr-live-births-monthly-2024": Path("packages/cdc/vsrr_live_births_2024"),
    "cdc-vsrr-live-births-monthly-2023": Path("packages/cdc/vsrr_live_births_2023"),
    "soi-table-1-2": Path("packages/irs_soi/table_1_2"),
    "soi-table-2-1": Path("packages/irs_soi/table_2_1"),
    "soi-table-2-5": Path("packages/irs_soi/table_2_5"),
    "soi-table-2-5-eitc-children-2020": Path(
        "packages/irs_soi/table_2_5_eitc_children_2020"
    ),
    "soi-table-2-5-eitc-agi-children-2022": Path(
        "packages/irs_soi/table_2_5_eitc_agi_children_2022"
    ),
    "soi-table-4-3": Path("packages/irs_soi/table_4_3"),
    "treasury-tax-expenditures-fy2023-eitc-outlays": Path(
        "packages/treasury/tax_expenditures_fy2023"
    ),
    "cms-aca-oep-state-level": Path("packages/cms_aca/oep_state_level"),
    "cms-aca-oep-state-level-2022": Path("packages/cms_aca/oep_state_level_2022"),
    "cms-aca-oep-state-level-2025": Path("packages/cms_aca/oep_state_level_2025"),
    "cms-aca-effectuated-enrollment-2022": Path(
        "packages/cms_aca/effectuated_enrollment_2022"
    ),
    "cms-medicaid-chip-monthly-enrollment-dataset": Path(
        "packages/cms_medicaid/chip_monthly_enrollment_dataset"
    ),
    "cms-medicaid-chip-monthly-enrollment-december-2024": Path(
        "packages/cms_medicaid/chip_monthly_enrollment_december_2024"
    ),
    "cms-medicare-state-payment-of-premiums": Path(
        "packages/cms_medicare/state_payment_of_premiums"
    ),
    "cms-medicare-trustees-report-2025-part-b-premium-income": Path(
        "packages/cms_medicare/medicare_trustees_report_2025"
    ),
    "cms-nhe-historical-service-source": Path(
        "packages/cms_nhe/historical_service_source"
    ),
    "dwp-benefit-cap-november-2025": Path("packages/dwp/benefit_cap_november_2025"),
    "dwp-benefit-statistics-february-2026": Path(
        "packages/dwp/benefit_statistics_february_2026"
    ),
    "dwp-pip-daily-living-foi-2025": Path("packages/dwp/pip_daily_living_foi_2025"),
    "dwp-uc-national-payment-dist-2025": Path(
        "packages/dwp/uc_national_payment_dist_2025"
    ),
    "dwp-uc-two-child-limit-2025": Path("packages/dwp/uc_two_child_limit_2025"),
    "dft-nts-household-car-availability-2024": Path(
        "packages/dft/nts_household_car_availability_2024"
    ),
    "dfc-ni-uc-statistics-may-2025": Path("packages/dfc_ni/uc_statistics_may_2025"),
    "dhs-ohss-unauthorized-immigrant-population-2018-2022": Path(
        "packages/dhs_ohss/unauthorized_immigrant_population_2018_2022"
    ),
    "cmsny-undocumented-population-2023": Path(
        "packages/cmsny/undocumented_population_2023"
    ),
    "federal-reserve-z1-household-net-worth": Path(
        "packages/federal_reserve/z1_household_net_worth"
    ),
    "hmrc-salary-sacrifice-relief-2024": Path(
        "packages/hmrc/salary_sacrifice_relief_2024"
    ),
    ...
    "hhs-acf-tanf-financial-2024": Path("packages/hhs_acf/tanf_financial_2024"),
    "hhs-acf-tanf-caseload-2024": Path("packages/hhs_acf/tanf_caseload_2024"),
    "hhs-acf-liheap-fy2023-national-profile": Path(
        "packages/hhs_acf_liheap/fy2023_national_profile"
    ),
    "hhs-acf-liheap-fy2024-national-profile": Path(
        "packages/hhs_acf_liheap/fy2024_national_profile"
    ),
    "isc-census-2024-pupil-count": Path("packages/isc/census_2024"),
    "jct-tax-expenditures-2024-mortgage-interest-deduction": Path(
        "packages/jct/tax_expenditures_2024"
    ),
    ...
    "nrs-mid-year-population-estimates-2024": Path(
        "packages/nrs/mid_year_population_estimates_2024"
    ),
    "obr-efo-expenditure": Path("packages/obr/efo_expenditure"),
    "obr-efo-receipts": Path("packages/obr/efo_receipts"),
    "ons-savings-interest-income": Path("packages/ons/savings_interest_income"),
    "ons-national-balance-sheet-land-2025": Path(
        "packages/ons/national_balance_sheet_land_2025"
    ),
    "ons-nomis-local-authority-population-2024": Path(
        "packages/ons/nomis_local_authority_population_2024"
    ),
    "ons-small-area-income-local-authority-2020": Path(
    ...
    "ons-uk-population-projections-2022": Path(
        "packages/ons/uk_population_projections_2022"
    ),
    "psca-67th-annual-401k-survey-roth-availability": Path(
        "packages/psca/annual_401k_survey_roth_availability_2023"
    ),
    "vanguard-how-america-saves-2024-roth-participation": Path(
        "packages/vanguard/how_america_saves_2024"
    ),
    "scotgov-council-tax-bands-2025": Path(
        "packages/scottish_government/council_tax_bands_2025"
    ),
    "scotgov-scottish-budget-social-security-assistance-2026": Path(
        "packages/scottish_government/scottish_budget_social_security_assistance_2026"
    ),
    "slc-student-loan-borrower-forecasts-england-2025": Path(
        "packages/slc/student_loan_borrower_forecasts_england_2025"
    ),
    "slc-student-loan-repayments-england-2025": Path(
        "packages/slc/student_loan_repayments_england_2025"
    ),
    "slc-student-loan-repayments-northern-ireland-2025": Path(
        "packages/slc/student_loan_repayments_northern_ireland_2025"
    ),
    "slc-student-loan-repayments-scotland-2025": Path(
        "packages/slc/student_loan_repayments_scotland_2025"
    ),
    "slc-student-loan-repayments-wales-2025": Path(
        "packages/slc/student_loan_repayments_wales_2025"
    ),
    "slc-student-support-england-2025": Path(
        "packages/slc/student_support_england_2025"
    ),
    "ssa-annual-statistical-supplement-2025": Path(
        "packages/ssa/annual_statistical_supplement_2025"
    ),
    "ssa-population-projections-tr2024": Path(
        "packages/ssa/population_projections_tr2024"
    ),
    "soi-historic-table-2": Path("packages/irs_soi/historic_table_2"),
    ...
    "soi-historic-table-2-state-eitc-2022": Path(
        "packages/irs_soi/historic_table_2_state_eitc_2022"
    ),
    "soi-congressional-district-2022": Path(
        "packages/irs_soi/congressional_district_2022"
    ),
    "soi-ira-roth-contributions-2022": Path(
        "packages/irs_soi/ira_roth_contributions_2022"
    ),
    "soi-ira-traditional-contributions-2022": Path(
        "packages/irs_soi/ira_traditional_contributions_2022"
    ),
    "soi-state-2022": Path("packages/irs_soi/state_2022"),
    ...
    def _artifact_content(
        ...
        if expected_sha:
            ...
            if actual_sha != expected_sha:
                raise ValueError(
                    f"Source artifact checksum mismatch for {spec['filename']}: "
...
def resolve_source_package_path(source: str | Path) -> Path:
    ...
    return _repo_root() / alias / SOURCE_PACKAGE_FILENAME
