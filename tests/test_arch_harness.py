"""Tests for the Arch fact validation harness."""

from __future__ import annotations

import json

from arch.harness import build_fixture_fact_file, validate_fixture_facts
from arch.store import load_facts_jsonl
