...
from arch.pe_source_plan import build_pe_source_plan
...
def test_build_pe_source_plan_classifies_agent_work(tmp_path):
    ...
    _write_manifest(
        ...
        [
            ...
            _row(
                ...
                format=".html",
                exists_locally="n/a",
                arch_source_status="source_package",
    ...
    assert "Manifest marks this row as source_package" in command_hints[
        "source_page.html"
    ]
...
def test_build_pe_source_plan_keeps_artifact_year_packages_to_pinned_year(
    ...
    assert "--year 2021" in items_by_filename[
        "irs_soi_ty2021_table_2_5.xls"
    ].command_hint
...
def test_build_pe_source_plan_routes_fred_to_publisher_lookup(tmp_path):
    ...
    assert "Do not use this FRED URL as an Arch source artifact" in item.command_hint
